...
// data : app's data(app's context)
// app_context->data : user data

int app_appcore_create(void *data)
{
	app_context_h app_context = data; // app_context_h is struct pointer for app_context_s
	...
	if (create_cb == NULL || create_cb(app_context->data) == false) // app_context->data is user data
	{
